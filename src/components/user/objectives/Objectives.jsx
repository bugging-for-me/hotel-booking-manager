      ...
      <div className="MuiBox-root jss110 jss105">
        <div className="MuiBox-root jss111 jss106">
          <span className="MuiBox-root jss112 jss109">
            ...
            />
            <div className="MuiBox-root jss113 jss107"></div>
          </span>
          <span
          ...
          <span className="MuiTypography-root jss108 MuiTypography-body1">
            Chat là có, gọi là nghe, không quản đêm hôm, ngày nghỉ và ngày lễ.
          </span>
        </div>
        <div className="MuiBox-root jss114 jss106">
          <span className="MuiBox-root jss115 jss109">
            <img
              src="https://storage.googleapis.com/tripi-assets/mytour/icons/icon_best_price.svg"
              alt="logo_best_price"
              style={{ width: '52px', height: '52px' }}
            />
            <div className="MuiBox-root jss116 jss107"></div>
          </span>
          <span
            className="MuiTypography-root MuiTypography-subtitle2"
            style={{ marginTop: '24px', whiteSpace: 'nowrap' }}
        ...
        <div className="MuiBox-root jss117 jss106">
          <span className="MuiBox-root jss118 jss109">
            <img
        ...
        <div className="MuiBox-root jss120 jss106">
          <span className="MuiBox-root jss121 jss109">
            <img
          ...
          <span className="MuiTypography-root jss108 MuiTypography-body1">
            Hàng nghìn khách sạn, đặc biệt là 4 sao và 5 sao, cho phép bạn thoải
            mái lựa chọn, giá cạnh tranh, phong phú.
          </span>
        </div>
      </div>
    </div>
